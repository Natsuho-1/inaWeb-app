            ...
            <div class="mb-3">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="iddocente" class="form-control"
                                value="{{ old('iddocente', $docente->iddocente ?? '') }}"
                                {{ isset($docente) ? 'readonly' : '' }} required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mt-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group mt-3">
                            ...
                            <input type="number" name="edad" class="form-control"
                                value="{{ old('edad', $docente->edad ?? '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group mt-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="estado_civil" class="form-control"
                                value="{{ old('estado_civil', $docente->estado_civil ?? '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group mt-3">
                            ...
                            <select name="sexo" class="form-select">
                                <option value="M" {{ old('sexo', $docente->sexo ?? '') == 'M' ? 'selected' : '' }}>
                                    Masculino</option>
                                <option value="F" {{ old('sexo', $docente->sexo ?? '') == 'F' ? 'selected' : '' }}>
                                    Femenino</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="celular_clase" class="form-control"
                                value="{{ old('celular_clase', $docente->celular_clase ?? '') }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="dui" class="form-control"
                                value="{{ old('dui', $docente->dui ?? '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="nit" class="form-control"
                                value="{{ old('nit', $docente->nit ?? '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mt-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="nivel" class="form-control"
                                value="{{ old('nivel', $docente->nivel ?? '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="categoria" class="form-control"
                                value="{{ old('categoria', $docente->categoria ?? '') }}" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mt-3">
                            ...
                            <input type="date" name="fecha_graduacion" class="form-control"
                                value="{{ old('fecha_graduacion', $docente->fecha_graduacion ?? '') }}" required>
                        </div>
                    </div>
                </div>
                <div class="form-group mt-3">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="inpep" class="form-control"
                                value="{{ old('inpep', $docente->inpep ?? '') }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group mt-3">
                            <label for="isss">ISSS</label>
                            <input type="text" name="isss" class="form-control"
                                value="{{ old('isss', $docente->isss ?? '') }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group mt-3">
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="nacionalidad" class="form-control"
                        value="{{ old('nacionalidad', $docente->nacionalidad ?? '') }}" required>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="pasaporte" class="form-control"
                                value="{{ old('pasaporte', $docente->pasaporte ?? '') }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="otros_cargos" class="form-control"
                                value="{{ old('otros_cargos', $docente->otros_cargos ?? '') }}">
                        </div>
                    </div>
                </div>
                <div class="form-group mt-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="telefono_otrainstitucion" class="form-control"
                                value="{{ old('telefono_otrainstitucion', $docente->telefono_otrainstitucion ?? '') }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mt-3">
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="idseccion" class="form-control"
                        value="{{ old('idseccion', $docente->idseccion ?? '') }}">
                </div>
                <div class="form-group mt-3">
                    <label for="idpersonal">ID Personal</label>
                    <input type="number" name="idpersonal" class="form-control"
                        value="{{ old('idpersonal', $docente->idpersonal ?? '') }}" required>
                </div>
            </div>
        </div>
