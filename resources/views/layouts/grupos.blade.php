...
<head>
    ...
    <title>@yield('title', 'Gestión de Grupos')</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light navbar-custom">
        <div class="container-fluid">
            ...
            <a class="navbar-brand ms-3" href="#">Gestión de Grupos</a>
    ...
    <div class="container-fluid">
        <div id="sidebarMenu" class="col-md-3 col-lg-2 sidebar">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a href="{{ route('grupos.index') }}" class="nav-link"><i class="bi bi-book-half"></i>
                        GRUPOS</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('grupos.create') }}" class="nav-link"><i class="bi bi-patch-plus-fill"></i>
                        AGREGAR GRUPOS</a>
                </li>
            </ul>
        </div>
